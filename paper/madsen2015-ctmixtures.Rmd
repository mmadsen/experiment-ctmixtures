...
\begin{figure}[ht]
\centering
\includegraphics{figure/equifinality-variable-effect.pdf}
\caption{Simple example of the effect of variable choice in distinguishing models: (A) simulated data points from two models, (B) the density of a variable which displays overlap between models, (C) the density of a variable which separates the two models.}
