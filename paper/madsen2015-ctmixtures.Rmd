...
\begin{tabular}{lll}
\hline
Variable                                   & Measured Object \\ \hline
Trait Configuration Richness      & Class          \\
Slatkin Exact         & Class          \\
Shannon Entropy  & Class \\
IQV Diversity  & Class \\
Neiman $T_f$ & Class \\
Slatkin Exact (Max of Loci)                & Loci          \\
Slatkin Exact (Min of Loci)                & Loci          \\
Slatkin Exact (Mean of Loci)                & Loci          \\
Shannon Entropy of Trait Frequencies (Min)  & Loci          \\
Shannon Entropy of Trait Frequencies (Max)  & Loci          \\
Shannon Entropy of Trait Frequencies (Mean) & Loci          \\
IQV Diversity Index (Min)  & Loci \\
IQV Diversity Index (Max)   & Loci \\
IQV Diversity Index (Mean)  & Loci \\
Trait Richness (Min) & Loci \\ 
Trait Richness (Max) & Loci \\
Trait Richness (Mean)  & Loci \\
Kandler-Shennan Trait Survival (Min) & Loci \\
Kandler-Shennan Trait Survival (Max) & Loci \\
Kandler-Shennan Trait Survival (Mean) & Loci \\
Neiman $T_f$ (Min) & Loci \\
Neiman $T_f$ (Max) & Loci \\
Neiman $T_f$ (Mean) & Loci \\
\hline

\end{tabular}
\label{tab:variables}
\caption{Variables measured from each transmission model simulation sample.  The right column records whether the variable is a measurement across traits in a single locus, and then summarized over loci, or whether it applies to configurations of all loci (classes).}
\end{table}
