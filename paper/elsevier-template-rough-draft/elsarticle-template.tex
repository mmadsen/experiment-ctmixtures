\documentclass[reprint,titlepage,authoryear,times,12pt]{elsarticle}

\usepackage[margin=1.25in]{geometry}

%\def\doctitle{Equifinality in Identifying Modes of Cultural Transmission in Heterogeneous Populations}
%\def\doctitle{A Systematic Approach to Identifying Equifinality Among Cultural Transmission Models in Heterogeneous Populations}
...
\usepackage[font=small,style=plain,floatrowsep=qquad,rowfill=yes,captionskip=5pt]{floatrow}
...
\journal{Journal of Archaeological Science or PLoS One}
