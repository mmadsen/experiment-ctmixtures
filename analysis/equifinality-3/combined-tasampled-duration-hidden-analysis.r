...
image_file <- get_data_path(suffix = "equifinality-3", filename = "classification-combined-tassize-combined_results-gbm.RData",
                            args = clargs)
...
image_file_results <- get_data_path(suffix = "equifinality-3", 
