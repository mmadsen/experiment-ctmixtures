...
test_pop_indices <- createDataPartition(eq5_pop_df$model_class_label, p = 0.1, list = FALSE)

eq5_pop_df <- eq5_pop_df[test_pop_indices,]
...
eq5_pop_df$two_class_label <- factor(ifelse(eq5_pop_df$model_class_label == 'allneutral', 'neutral', 'biased'))
