...
load(get_data_path(suffix = "experiment-ctmixtures/equifinality-5/results", filename = "balancedbias-neutral-comparison-gbm-dfonly.RData"))
balanced_bias_results <- data.frame(bias_results)
rm(bias_results)

load(get_data_path(suffix = "experiment-ctmixtures/equifinality-5/results", filename = "bias-model-comparisons-gbm-dfonly.RData"))
...
image_file <- get_data_path(suffix = "experiment-ctmixtures/equifinality-5/results", filename = "biased-gbm-merged-dfonly.RData")
