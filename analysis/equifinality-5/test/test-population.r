...
valdata$two_class_label <- factor(ifelse(valdata$model_class_label == 'allneutral', 'neutral', 'biased'))
...
model <- train_gbm_classifier(valdata, training_set_fraction, "two_class_label", gbm_grid, training_control, exclude_columns, verbose=FALSE)
